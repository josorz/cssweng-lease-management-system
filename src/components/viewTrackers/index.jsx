...
import handleSignOut from "../dashboard/index";
...
const ViewTrackers = () => {
  return (
    <div>
      ...
      <link
        rel="stylesheet"
        href="https://fonts.googleapis.com/css?family=Poppins%3A400%2C500%2C600%2C700"
      />
      <link
        rel="stylesheet"
      ...
      <div className="property-summary-dashboard-4Qo">
        <div className="auto-group-uzsb-ZsM">
          ...
          <div className="header-bJF"></div>
          <p className="twenty25-t2T">twenty25.</p>
          <p className="sign-out-Akf" onClick={handleSignOut}>
            Sign Out
          </p>
          ...
          <div className="rectangle-88-rRm"></div>
          <div className="rectangle-89-PRh"></div>
        </div>
