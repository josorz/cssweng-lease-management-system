...
import 'styles/home.css'; // Make sure the path to your stylesheet is correct
import "./home.css";
    ...
    <div>
      ...
      <div className="property-dashboard-fLB">
        ...
        <div className="property-9-H8b">
          ...
          <img className="mask-group-CHV" src="../../assets/mask-group-xyM.png" />
        ...
        <div className="property-10-cc7">
          ...
          <img className="mask-group-Htb" src="../../assets/mask-group-SHm.png" />
        ...
        <div className="property-13-KKV">
          ...
          <img className="mask-group-r6T" src="../../assets/mask-group-ew1.png" />
        ...
        <div className="property-14-h75">
          ...
          <img className="mask-group-3yZ" src="../../assets/mask-group-5Zh.png" />
        ...
        <div className="property-11-HN7">
          ...
          <img className="mask-group-bvX" src="../../assets/mask-group-Pf5.png" />
        ...
        <div className="property-12-edu">
          ...
          <img className="mask-group-ccf" src="../../assets/mask-group-ixF.png" />
          <div className="rectangle-64-9sV">
          </div>
        </div>
        <img className="icon-plus-4Uf" src="../../assets/icon-plus-ygT.png" />
